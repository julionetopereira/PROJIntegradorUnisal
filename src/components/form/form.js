    ...
    <div className="pt-32 pb-36">
      ...
      >
        <div className="hidden bg-cover lg:block lg:w-1/2">
          <img
            id="form_IMG"
            className="flex items-center ml-12 mt-12"
            src={banner}
            alt="banner"
          />
        </div>
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          <p className="text-xl text-center text-gray-700">Welcome back</p>
          <a
            href="#"
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-8">
              <button
                id="login"
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-blue-700 rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
              >
                Login
              </button>
            </div>
